...
DiscordHandlers.prototype.handleGuildMemberAdd = function handleGuildMemberAdd(member) {
    return this.sendMemberLogEvent(member, 'join');
};

DiscordHandlers.prototype.handleGuildMemberRemove = function handleGuildMemberRemove(member) {
