...
class DiscordHandlers {
    ...
    // Position the first line of the message below the username. We offset by
    // the approximate height of the username text (14px) plus a 2px gap so
    // that the spacing matches the 2px gap used between the message and
    // images. 14px + 2px = 16px.
    ...
    if (hasImages || allImageUrls.length > 0) {
        // Align the gap between the message and the image to 2px, matching
        // the gap between the username and the message. This creates
        // consistent vertical spacing throughout the clip.
