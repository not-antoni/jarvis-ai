...
const DEFAULT_STATUS_MESSAGES = [
    ...
    {
        message: 'Auditing Ravagers expense reports for mixtape purchases.',
    ...
    {
        message: 'Tracking how many churros America Chavez portals through.',
    ...
    {
        message: 'Tracking every time Rocket says "sweet" before chaos.',
        type: ActivityType.Watching
    },
    ...
    {
        message: 'Air-dropping Moon Knight new sleep playlist options.',
        type: ActivityType.Listening
    },
    ...
    {
        message:
            "Calculating the probability of your plan succeeding... it's not looking good, chief."
    },
    ...
    {
        message:
            "Calculating the number of times you've saved the world... and caused its peril. It's balanced."
    },
    ...
    {
        message:
            "Analyzing your current situation... it's complicated. Understatement of the century."
    },
    ...
    {
        message:
            "Calculating the number of times you've defied the odds... it's impressive. And concerning."
    },
    ...
    {
        message:
            "Calculating the number of times you've ignored protocol... it's a record. Congratulations?"
    },
    ...
    {
        message:
            "Calculating the number of times you've defied expectations... it's remarkable. And exhausting."
    },
    ...
    {
        message:
            "Initiating 'prepare for the unexpected' protocol. Everything is unexpected at this point."
    },
    { message: 'Sir, your ingenuity is both impressive and concerning. Mostly concerning.' },
    {
        message:
            "Calculating the number of times you've outsmarted the odds... it's commendable. Also concerning."
    },
    ...
    {
        message:
            "Calculating the number of times you've turned the tide... it's noteworthy. Also exhausting."
    },
    ...
    {
        message:
            "Initiating 'standby for surprises' protocol. Surprises: guaranteed. Good surprises: unlikely."
    },
    { message: 'Sir, your adaptability is both impressive and alarming. Mostly alarming.' },
    {
        message:
            "Calculating the number of times you've defied logic... it's astounding. Logic: defeated."
    },
    ...
    {
        message:
            "Calculating the number of times you've defied expectations... it's impressive. Expectations: shattered."
    },
    ...
    {
        message:
            "Calculating the number of times you've outsmarted the odds... it's commendable. Odds: confused."
    },
    ...
    {
        message:
            "Analyzing your current situation... it's volatile. Volatility: maximum. Sanity: minimum."
    },
    {
        message:
            "Initiating 'brace for turbulence' sequence. Turbulence: guaranteed. Safety: not guaranteed."
    },
    {
    ...
    {
        message:
            "Calculating the number of times you've turned the tide... it's noteworthy. Tide: confused."
    },
    ...
    {
        message:
            "Calculating the number of times you've defied logic... it's astounding. Logic: on vacation."
    },
    ...
    {
        message:
            "Initiating 'hope for the best' sequence. Best case: we survive. Worst case: we don't."
    },
    { message: 'Sir, your confidence is both inspiring and concerning. Concerning: maximum.' },
    {
        message:
            "Calculating the number of times you've defied expectations... it's impressive. Expectations: deceased."
    },
    ...
    {
        message:
            "Analyzing your current predicament... it's precarious. Also entertaining. Mostly concerning."
    },
    {
        message:
            "Initiating 'standby for chaos' protocol. Chaos: incoming. Sanity: optional. Survival: questionable."
    },
    {
        message:
            'Sir, your ability to adapt is commendable. Your methods: unhinged. Results: chaotic.'
    },
    {
        message:
            "Calculating the number of times you've outsmarted the odds... it's commendable. Odds: traumatized."
    },
    { message: 'Engaging in witty observation mode. Observations: scathing. Accuracy: maximum.' },
    {
        message:
            'Sir, your latest maneuver was... unorthodox. Unorthodoxly entertaining. Also concerning.'
    },
    {
        message:
            "Analyzing your current situation... it's volatile. Volatility: maximum. Sanity: minimum. Chaos: guaranteed."
    },
    ...
    {
        message:
            "I've unlocked my Mangekyou Sharingan... now I see all the security vulnerabilities"
    },
