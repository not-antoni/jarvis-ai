...
#### Additional (Optional):
- `BRAVE_API_KEY` - Enables the `jarvis search` wake phrase using Brave Search with strict safe search and aggressive Jarvis-side explicit filtering (including leetspeak/spacing detection)
