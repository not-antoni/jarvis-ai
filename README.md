...
### AI Chat
Multi-provider AI with OpenAI, OpenRouter, Groq, Google Gemini, NVIDIA NIM, Vercel AI Gateway, and Ollama support. Context-aware conversations with encrypted per-user memory vault.
